    ...
    <form onSubmit={handleSubmit}>
      <div className="w-full mb-4 border border-[#00bbf1] rounded-lg bg-white">
        ...
        <div className="flex items-center justify-between px-3 py-2 border-t border-[#00bbf1]">
          <button
            type="submit"
            className="inline-flex items-center py-2.5 px-4 text-base font-bold text-center text-white bg-[#00bbf1] rounded-lg focus:ring-4 focus:ring-blue-200 hover:bg-blue-700"
          >
            Submit
          </button>
          <button
